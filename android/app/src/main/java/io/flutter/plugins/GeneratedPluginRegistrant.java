...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.mrproject.liquid_pull_refresh.LiquidPullRefreshPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin liquid_pull_refresh, com.mrproject.liquid_pull_refresh.LiquidPullRefreshPlugin", e);
    }
    try {
